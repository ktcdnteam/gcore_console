...
(function($) {
    ...
    function mousedownHandler(event) {
        ...
        document.getElementById("top-component").style.height = null;
...
//                
//                if(document.getElementById('bottom-component').scrollHeight > document.getElementById('bottom-component').offsetHeight) {
//                    
//                }
